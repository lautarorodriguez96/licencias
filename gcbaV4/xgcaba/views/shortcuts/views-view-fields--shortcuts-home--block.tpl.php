...
?>
<?php
	echo (user_access('create shortcut content') ? '<a class="inline-edit" href="node/'.$row->nid.'/edit?destination='.current_path().'">editar shortcut</a>' : '');
?>
<a class="col-md-3 col-sm-6 shortcut" href="<?php echo $row->field_field_link[0]['raw']['url'] ?>">
	<span>
